...
//   RAMLS1           : origin = 0x00008800, length = 0x00000800
   RAMLS2LS3LS4LS5  : origin = 0x00009000, length = 0x00002000
...
SECTIONS
{
   ...
   dclfuncs         : > FLASH_BANK0_SEC1,     ALIGN(4)
    ...
    Cla1Prog        : LOAD = FLASH_BANK0_SEC6,
                      RUN = RAMLS2LS3LS4LS5,
...
//         LOAD_START(_isrcodefuncsLoadStart),               commented out because of change from COFF to EABI
...
//                       /* CLA specific sections */                      //temporally comment out when CLA is not enabled
